...
SUMMARY_DIAGNOSTIC_EXCLUDE_FIELDS = {
    ...
    "n_pred_audioset_parent_nodes",
    "n_gt_audioset_parent_nodes",
    "pred_audioset_tags",
    "gt_audioset_tags",
    "pred_audioset_categories",
    "gt_audioset_categories",
    "pred_audioset_node_names",
    "gt_audioset_node_names",
    "pred_audioset_parent_node_names",
    "gt_audioset_parent_node_names",
    "pred_audioset_top_level_names",
    "gt_audioset_top_level_names",
    "pred_audioset_node_paths",
